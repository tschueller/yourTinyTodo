...
$().ready(function(){
	...
	mytinytodo.init({
		...
		showdate: <?php echo (Config::get('showdate') && !$pda) ? "true" : "false"; ?>,
		singletab: <?php echo (isset($_GET['singletab']) || $pda) ? "true" : "false"; ?>,
		...
		<?php if($pda) echo ", touchDevice: true"; ?>
	}).loadLists(1);
});
</script>
...
<div id="bar">
 ...
 <span style="font-size:small;">
 		<span><?=date("d.m.y ");?></span><span><?=date("G:i");?></span>
 		<? if (!$pda) { ?>
 		<a href="#reloadPage" id="reloadPage">reload</a>
 		<? } ?>
 </span>
 <span class="bar-delim"> | </span>
...
<!-- added by tsc, 09.10.2017 -->
<div class="form-row form-row-short" style="float:right">
  <!--<span class="h"><?php _e('#');?> </span>-->
  <a id="editTaskId" href="#"></a>
</div>
...
<div class="form-row"><div class="h"><?php _e('tags');?></div>
 <table cellspacing="0" cellpadding="0" width="100%"><tr>
  ...
  <td class="alltags-cell">
   <a href="#" id="alltags_show" style="display:none;"><?php _e('alltags_show');?></a>
   <a href="#" id="alltags_hide"><?php _e('alltags_hide');?></a></td>
 </tr></table>
</div>
<div class="form-row" id="alltags"><?php _e('alltags');?> <span class="tags-list"></span></div>
...
<div id="footer"><div id="footer_content">Powered by <strong><a href="http://www.mytinytodo.net/">myTinyTodo</a></strong> 1.4.2 </div></div>
